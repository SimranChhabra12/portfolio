    ...
    <main style={{ backgroundColor: T.cream }} className="min-h-screen overflow-x-hidden">
      ...
      <section className="px-8 lg:px-16 pt-40" style={{ paddingBottom: T.space.section }}>
        <div className="max-w-4xl">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mt-16 max-w-3xl">
            {[
      ...
      <div className="px-8 lg:px-16 min-w-0">
        <div className="max-w-4xl flex flex-col min-w-0">
          ...
          <Section id="solution" number="07" heading="The Solution">
            ...
            <div className="flex flex-col gap-4 w-full" style={{ paddingTop: "0.5rem" }}>
              <H2>Give it a try</H2>
              <P>
