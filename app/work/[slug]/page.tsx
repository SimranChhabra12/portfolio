...
// Every case study now has a hand-built route (app/work/whspr, aira-pcos, resy,
// gesture-sketch, dream-of)
...
const BESPOKE_ROUTES = new Set(["whspr", "aira-pcos", "resy", "gesture-sketch", "dream-of"]);
